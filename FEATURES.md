# InvoiceForge — Features & Capabilities
...
### Import
- Accepts any `.json` file exported by InvoiceForge
...
InvoiceForge has a built-in **one-click translation** between **English** and **Khmer** (ខ្មែរ).
